  ...
  <view class="template-blogger tn-safe-area-inset-bottom">
    ...
    <view class="blogger-tips-data">
      <view class="blogger-tips-data__wrap tn-bg-white">
        <view
          class="blogger-tips-data__message tn-flex tn-flex-row-center"
        ...
        >
          ...
          >
            ...
            <view class="tn-padding-right tn-padding-left"
              >{{ tipsDataMessage.messageCount }} 条新消息</view
            >
          </view>
        </view>
        <view class="blogger-tips-data__info tn-flex">
          <view class="tn-flex-1 tn-padding-sm tn-margin-xs">
            ...
            >
              ...
              <view
                class="tn-margin-top-xs tn-color-gray tn-text-df tn-text-center"
              >
                <text class="tn-icon-like"></text>
                <text class="tn-padding-left-xs">人数</text>
              </view>
            </view>
          </view>
          <view class="tn-flex-1 tn-padding-sm tn-margin-xs">
            ...
            >
              <view class="">
                <view class="tn-text-xxl tn-color-blue">{{
                  $t.number.formatNumberAddPriceUnit(
                    tipsDataMessage.hotReviewsCount
                  )
                }}</view>
              </view>
              <view
          ...
          <view class="tn-flex-1 tn-padding-sm tn-margin-xs">
            ...
            >
              ...
              >
                ...
                <text class="tn-padding-left-xs">排名</text>
              </view>
            </view>
          </view>
        </view>
...
.cube {
  ...
  &__container {
    ...
    &__body {
      ...
      animation: cubeFrame 35s cubic-bezier(0.36, -0.03, 0.46, 0.95) infinite
        alternate;
