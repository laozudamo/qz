  ...
  <view>
    ...
    <view class="input-box" :class="showEmji" @touchmove.stop.prevent="discard">
      ...
      <view class="more" @tap="chooseImage">
        <text class="tn-icon-image-fill tn-mask-bg-color tn-text-xxl"></text>
      </view>
      <!-- #endif -->
      <view class="textbox">
        <view
      ...
      <!-- #ifndef H5 -->
      <view class="more" @tap="chooseImage">
        <text class="tn-icon-image-fill tn-color-purplered tn-text-xxl"></text>
      </view>
      <!-- #endif -->
      <label for="textMsg">
    ...
    getMsgList() {
      ...
      let list = [
        ...
        },
        {
          ...
          time: "13:05",
          type: "voice",
          msg: { url: "/static/voice/2.mp3", length: "00:06" },
        },
        {
          id: 4,
          uid: 0,
          ...
          time: "13:05",
          type: "img",
          msg: { url: "/static/img/goods/p10.jpg", w: 200, h: 200 },
        },
        {
          id: 5,
          uid: 1,
          ...
          time: "12:59",
          type: "img",
          msg: { url: "/static/img/q.jpg", w: 1920, h: 1080 },
        },
      ];
      // 获取消息中的图片,并处理显示尺寸
