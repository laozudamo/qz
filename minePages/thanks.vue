<template>
  <view class="template-thanks tn-safe-area-inset-bottom">
    ...
    <view class="tn-margin tn-text-lg">
      ...
      <view class="tn-padding-bottom">
        出这套模板，主要是为了感谢一路支持 的大佬们
      </view>
      
      
      <view class="tn-padding-bottom">
        接下来，上线【 模板】新项目后，又会停更一个月，6月份要去恰饭接单了，毕竟要赚生活费、房租费等等鸭
      </view>
      
      <view class="tn-padding-bottom">
        对，“这界面谁不会写”，国内不缺少能力出众的人，也不缺少优秀的 开心作者，可活下去的 开心项目却是极少数
      </view>
      
      <view class="tn-padding-bottom">
        其次，谩骂、质疑、圈钱、抄袭声也不少，但努力做好 就行吖，因为一个好心态，才能出一个好作品（其实是经历了太多，反而觉得被骂才是正常的了）
      </view>
