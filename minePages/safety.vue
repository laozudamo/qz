  ...
  <view class="template-safety tn-safe-area-inset-bottom">
    ...
    <view class="login">
      ...
      <view class="login__bg login__bg--top">
        <image
          class="bg"
          src="https://resource.tuniaokj.com/images/login/2/login-top2.png"
          mode="widthFix"
        ></image>
      </view>
      ...
      <view class="login__wrapper tn-padding">
        ...
        >
          ...
          <view
            ...
            :hover-stay-time="150"
            @click="submit"
            >{{ currentModeIndex === 0 ? "修改昵称" : "修改密码" }}</view
          >
        </view>
      </view>
      ...
      <view class="login__bg login__bg--bottom">
        <image
          src="https://resource.tuniaokj.com/images/login/2/login-bottom2.png"
          mode="widthFix"
        ></image>
      </view>
    </view>
  ...
  methods: {
    changeName() {
      ...
      updateInfo(data).then((res) => {
        ...
        uni.getStorageSync("userInfo", data);
