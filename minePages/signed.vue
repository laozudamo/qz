<template>
  <view class="template-screen tn-safe-area-inset-bottom">
    ...
    <tn-nav-bar :isBack="false" :bottomShadow="false" backgroundColor="none">
      ...
      >
        ...
        <view class="custom-nav__back">
          <view
            class="tn-icon-backspace tn-color-white"
        ...
        >
          <view
            class="custom-nav__search__box tn-flex tn-flex-col-center tn-flex-row-center tn-color-white"
          >
    ...
    <view class="">
      ...
      >
        <view
          class="tn-bg-white tn-margin tn-text-center"
          style="border-radius: 20rpx"
        >
          <view
            class="tn-flex tn-flex-row-around tn-padding-sm tn-bg-blue--light"
          ...
          <view class="">
            ...
            <view class="tn-text-bold tn-margin-top-sm tn-text-xxl"
              >43545323233</view
            >
                ...
                >
                  ...
                  >
                    ...
                    <view class="tn-text-center">
                      <text class="tn-text-ellipsis tn-text-sm tn-color-gray"
                        >第{{ index + 1 }}天</text
                      >
                    </view>
                  </view>
      ...
      <view class="tn-margin">
        <view class="screen-shadow tn-bg-white tn-padding tn-color-gray">
          <view
            class="tn-text-center tn-text-lg tn-padding-xs tn-text-bold tn-color-black"
          >
            积分规则
          </view>
          <view class="tn-padding-top"> 1.签到可获取10积分 </view>
    ...
    <view class="tabbar footerfixed">
      <!-- <view class="action">
        <view class="bar-icon">
          <view class="tn-icon-search-menu tn-color-gray--dark"> </view>
        </view>
      ...
      <!-- <view class="action">
        <view class="bar-icon">
          <view class="tn-icon-clock tn-color-gray--dark"> </view>
        </view>
