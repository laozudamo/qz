  ...
  <view class="template-login">
    ...
    <view class="login">
      ...
      <view class="login__bg login__bg--top">
        <image
          class="bg"
          src="https://resource.tuniaokj.com/images/login/1/login_top2.jpg"
          mode="widthFix"
        ></image>
      </view>
      <view class="login__bg login__bg--top">
        <image
          ...
          src="https://resource.tuniaokj.com/images/login/1/login_top3.png"
          mode="widthFix"
        ></image>
      </view>
      ...
      <view class="login__wrapper">
        ...
        >
          ...
          <view class="tn-flex login__info__item__button">
            <view class="tn-flex-1 justify-content-item tn-text-center">
              <tn-button
                ...
                shape="round"
                backgroundColor="tn-cool-bg-color-7--reverse"
                padding="40rpx 0"
                width="100%"
                shadow
                fontBold
          ...
          <view v-if="currentModeIndex === 0" class="login__info__item__tips"
            >忘记密码?</view
          >
        </view>
      ...
      <view class="login__bg login__bg--bottom">
        <image
          src="https://resource.tuniaokj.com/images/login/1/login_bottom_bg.jpg"
          mode="widthFix"
        ></image>
      </view>
    </view>
