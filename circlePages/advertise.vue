  ...
  <view class="template-advertise">
        ...
        <view class="tn-flex tn-flex-col-center tn-flex-row-left">
          <view class="user-pic">
            <view class="user-image">
              <view class="tn-shadow-blur" style="background-image:url('/static/avator.jpg');width: 100rpx;height: 100rpx;background-size: cover;">
              </view>
            </view>
          </view>
          <view class="tn-padding-right tn-color-black">
            <view class="tn-padding-right tn-padding-left-sm">
              <text class="tn-text-lg tn-text-bold"> 北北</text>
              <text class="tn-padding-left-sm">打杂UI</text>
            </view>
            <view class="tn-padding-right tn-padding-top-xs tn-padding-left-sm tn-text-ellipsis">
              <text class="tn-color-blue--dark tn-text-bold">抓住那只猪</text>
            </view>
          </view>
        </view>
      </view>
    ...
    <tn-landscape :show="show2" @close="closeLandscape">
      <view class="tn-text-center" @click="navTuniaoUI">
        ...
        <text class="tn-text-lg tn-color-white tn-padding-top-lg">——  UI，2022年已上线 ——</text>
      </view>
    </tn-landscape>
