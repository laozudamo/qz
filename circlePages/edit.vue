<template>
  <view class="template-edit tn-safe-area-inset-bottom">
    ...
    <view
      class="tn-safe-area-inset-bottom"
      :style="{ paddingTop: vuex_custom_bar_height + 'px' }"
    >
      <view
        class="tn-flex tn-flex-row-between tn-flex-col-center tn-padding-top tn-margin"
      >
      ...
      >
        ...
        <view
          class="justify-content-item tn-text-df tn-color-grey"
          @tap="clear"
        >
      ...
      <view class="tn-flex tn-footerfixed">
        ...
        >
          ...
          >
            ...
            <text
              class="tn-icon-camera tn-padding-left-xs tn-color-black"
            ></text>
          </tn-button>
        </view>
      </view>
