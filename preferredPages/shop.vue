<template>
  <view class="template-shop tn-safe-area-inset-bottom">
    ...
    <!-- 店铺 start-->
    <view
      class="shop-function tn-margin-bottom-xl"
    ...
    <!-- 更多信息-->
    <view
      class="shop-shadow tn-margin tn-color-black tn-bg-white"
      style="position: relative; z-index: 1; padding: 30rpx 6rpx"
    >
    ...
    <view class="">
      <view class="nav_title--wrap">
        <view class="nav_title tn-bg-black">
          ...
          <text class="tn-text-xl">优质产品</text>
      ...
      <block v-for="(item, index) in content" :key="index">
        ...
        >
          <view class="tn-blogger-content__wrap">
                ...
                <view>
                  <view class="">
                    ...
                    <text
                      ...
                      style="font-size: 24rpx; text-decoration: line-through"
                      >￥{{ item.likeCount }}</text
                    >
                  </view>
                </view>
            ...
            <view
              class="tn-flex tn-flex-col-center tn-padding-left-sm tn-padding-right-sm tn-padding-bottom-sm"
            >
              <view class="justify-content-item tn-flex tn-flex-col-center">
                ...
                <text class="tn-color-gray"
                  >{{ item.viewUser.viewUserCount }}人查看</text
                >
              </view>
            </view>
          </view>
    ...
    <view class="">
      <view class="nav_title--wrap">
        <view class="nav_title tn-bg-black">
          <text class="tn-text-xl">品质服务</text>
        </view>
      </view>
    </view>
      ...
      <block v-for="(item, index) in content2" :key="index">
        <view class="tn-blogger-content2__wrap">
          <view class="tn-padding-top-xs">
            <!-- 方式一 -->
            <view
              class="tn-shadow-blur image-pic"
              :style="'background-image:url(' + item.mainImage + ')'"
            >
          ...
          <view
            class="tn-blogger-content2__label tn-text-justify tn-margin-top tn-margin-bottom-sm"
          >
            <text
              class="tn-blogger-content2__label__desc tn-text-bold tn-text-xl"
              >{{ item.desc }}</text
            >
          </view>
          ...
          >
            <view class="justify-content-item tn-flex tn-flex-col-center">
              <view style="margin-right: 10rpx; margin-left: 0rpx">
                <view class="tn-color-gray">
                  <text
                    class="tn-blogger-content2__count-icon tn-icon-flower"
                  ></text>
                  <text class="tn-padding-right">{{
                    item.collectionCount
                  }}</text>
                  <text
                    class="tn-blogger-content2__count-icon tn-icon-message"
                  ></text>
                  <text class="tn-padding-right">{{ item.commentCount }}</text>
                  <text
                    class="tn-blogger-content2__count-icon tn-icon-like"
                  ></text>
            ...
            <view class="justify-content-item tn-text-center">
              <view
                ...
                :key="label_index"
                class="tn-blogger-content2__label__item tn-float-left tn-margin-right tn-bg-gray--light tn-round tn-text-sm tn-text-bold"
              >
                <text class="tn-blogger-content2__label__item--prefix">#</text>
                {{ label_item }}
              </view>
            </view>
          </view>
    ...
    <view class="">
      <view class="nav_title--wrap">
        <view class="nav_title tn-bg-black">
          <!-- <text class="tn-icon-relation tn-padding-right-sm tn-text-xxl"></text> -->
          <text class="tn-text-xl">村庄动态</text>
          <!-- <text class="tn-icon-relation tn-padding-left-sm tn-text-xxl"></text> -->
        </view>
      </view>
    </view>
            ...
            <view class="tn-margin-sm tn-padding-top-xs" style="width: 100%">
              ...
              <view class="tn-flex tn-flex-row-between tn-flex-col-between">
                ...
                >
                  ...
                  <text
                    class="tn-icon-like-lack tn-padding-right-xs tn-text-lg"
                  ></text>
    ...
    <tn-modal v-model="show1" :custom="true">
      <view class="custom-modal-content">
        <image
          ...
          src="https://baike.baidu.com/item/%E4%BA%8C%E7%BB%B4%E7%A0%81/2385673"
          mode="aspectFill"
          style="width: 100%"
        ></image>
        <view class="tn-text-center tn-padding-top">村庄群</view>
    ...
    <view class="tabbar footerfixed dd-glass" style="border-radius: 100rpx">
      <view class="action">
        <view class="bar-icon">
          <view class="tn-icon-company tn-color-grey--dark"> </view>
      ...
      <view class="action" @click="callPhoneNumber" data-number="18219126666">
        <view class="bar-icon">
          <view class="tn-icon-tel tn-color-grey"> </view>
      ...
      <view class="action" @click="showModal">
        <view class="bar-icon">
          <view class="tn-icon-wechat tn-color-grey"> </view>
