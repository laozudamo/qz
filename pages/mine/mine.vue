<template>
  <view class="template-mine tn-safe-area-inset-bottom">
    ...
    <view class="top-backgroup">
      <image
        src="https://resource.tuniaokj.com/images/my/my-bg2.png"
        mode="widthFix"
    ...
    <view class="about__wrap">
        ...
        <view class="justify-content-item">
          ...
          >
            ...
            <view class="tn-padding-right">
              ...
              >
                <text class="tn-color-brown" style="opacity: 0.5"
                  >认证会员</text
                >
                <text class="tn-color-brown tn-text-bold tn-padding-left-sm"
                  >SVIP 6</text
                >
              </view>
            </view>
      ...
      <!-- <view class="tn-flex">
        <view class="tn-flex-1 about-shadow tn-bg-white" style="margin: 30rpx 15rpx 0 0;padding: 30rpx 0;" @click="navTuniaoWebsite">
          <view class="tn-flex tn-flex-direction-column tn-flex-row-center tn-flex-col-center">
            ...
            <view class="tn-text-center" style="font-size: 30rpx;">
              <view class="tn-text-ellipsis"> 官网</view>
            </view>
          </view>
        </view>
        <view class="tn-flex-1 about-shadow tn-bg-white" style="margin: 30rpx 0 0 15rpx;padding: 30rpx 0;" @click="navTuniaoUI">
          <view class="tn-flex tn-flex-direction-column tn-flex-row-center tn-flex-col-center">
            ...
            <view class="tn-text-center" style="font-size: 30rpx;">
              <view class="tn-text-ellipsis"> UI</view>
            </view>
          </view>
        </view>
      </view> -->
        ...
        <view class="tn-flex tn-flex-row-center tn-radius tn-padding-top">
          ...
          <!-- <view class="tn-padding-sm tn-margin-xs tn-radius" @click="tn('/minePages/cart/cart')">
            <view class="tn-flex tn-flex-direction-column tn-flex-row-center tn-flex-col-center">
              ...
              <view class="tn-text-center">
                <text class="tn-text-ellipsis">购物车</text>
              </view>
            </view>
          </view> -->
        </view>
      ...
      <!-- <tn-list-cell :hover="true" :unlined="true" :radius="true" :fontSize="30" @click="copySource">
          <view class="tn-flex tn-flex-col-center">
            ...
            <view class="tn-margin-left-sm tn-flex-1"> 开心地址</view>
      ...
      <view
        class="about-shadow tn-margin-top-lg tn-margin-bottom-lg tn-padding-top-sm tn-padding-bottom-sm"
      >
