  ...
  <view class="template-circle tn-safe-area-inset-bottom">
    ...
    <tn-nav-bar :isBack="false" :bottomShadow="false" backgroundColor="none">
      <view class="custom-nav tn-flex tn-flex-col-center tn-flex-row-left">
        <!-- 个人村庄，默认显示自己头像，当有消息互动的时候，显示别人的头像，并且有一个红点点 -->
    ...
    <view class="" v-if="current == 0">
      ...
      >
        ...
        >
          <view
            class="justify-content-item tn-text-center tn-flex"
            style="padding: 25rpx 30rpx"
          >
            <tn-avatar-group
              :lists="latestUserAvatar"
              size="sm"
            ></tn-avatar-group>
            <text class="tn-padding-xs">1629 人</text>
          </view>
          <view class="justify-content-item tn-text-right tn-padding-top-sm">
            <view class="tn-text-bold"> 村庄 · 积分榜 </view>
            <view class="tn-text-xs tn-color-gray--dark tn-padding-top-xs">
              积分可兑换精美周边
            </view>
          </view>
          <view
            class="justify-content-item tn-text-right tn-margin-right tn-padding-top-lg"
          >
            ...
            >
              ...
              >
                <view class="tn-radius tn-padding-sm">
                  ...
                  <view class="tn-text-center tn-text-bold tn-padding-top-xs">{{
                    item.name
                  }}</view>
                  <view
      ...
      <view
        class="tn-flex tn-flex-direction-column tn-margin-top-sm tn-margin-bottom"
      >
        <!-- 图文信息 -->
        <block v-for="(item, index) in content">
          <view class="blogger__item" :key="index">
            ...
            >
              ...
              <text
                v-if="!item.label || item.label.length < 4"
                ...
                <image
                  ...
                  :class="{
                    ...
                    'blogger__main-image--2 tn-margin-right-sm tn-margin-bottom-sm':
                      item.mainImage.length === 2 ||
                      item.mainImage.length === 4,
                  }"
                  :src="image_item"
                  mode="aspectFill"
                ></image>
            ...
            <view class="justify-content-item">
              <view class="tn-flex tn-flex-col-center tn-flex-row-left">
                ...
                <view class="tn-padding-right" style="width: 65vw">
                  ...
                  >
                  <view
                    class="tn-padding-right tn-padding-left-sm tn-color-gray tn-text-ellipsis"
                    >我们都是好好孩子</view
                  >
                </view>
              </view>
            ...
            <view class="tn-flex">
              ...
              <view class="tn-margin-sm tn-padding-top-xs" style="width: 100%">
                ...
                >
                  ...
                  <view class="justify-content-item tn-flex tn-flex-col-center">
                    <text class="tn-color-gray"
                      >{{ item.viewUser.viewUserCount }} 人参与</text
                    >
                  </view>
                </view>
                <view class="tn-flex tn-flex-row-between tn-flex-col-between">
                  <view
                    ...
                    :class="[
                      `tn-bg-${item.color}--light tn-color-${item.color}`,
                    ]"
                  >
...
.hx-box .pr .pa0 .span {
  ...
  width: 100%;
  height: 100%;
  background: url(https://resource.tuniaokj.com/images/cool_bg_image/arc4.png)
